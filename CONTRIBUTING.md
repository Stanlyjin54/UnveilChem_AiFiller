...
1. 检查 [Issues](https://github.com/yourusername/UnveilChem/issues) 确认问题未被报告
...
```bash
git clone https://github.com/yourusername/UnveilChem.git
cd UnveilChem
```
...
- GitHub Issues: [提交问题](https://github.com/yourusername/UnveilChem/issues)
- Email: contact@unveilchem.com
